...
def test_numeric_overlaps(thresh_dist=decimal.Decimal('103500000000000.0'), resolution=1, candidate=decimal.Decimal('-1702167554017.3978779871393661')):
    assume(abs(candidate.adjusted()-thresh_dist.adjusted()) < 28)
    ...
    numbers = [comp.context.add(candidate, thresh_dist * decimal.Decimal(str(i/10))) for i in range(20)]
